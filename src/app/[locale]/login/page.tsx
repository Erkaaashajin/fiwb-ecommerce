      ...
      <main className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 sm:py-24">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-md">
          ...
          <div className="bg-card border border-border rounded-2xl p-6 sm:p-8 space-y-6">
            ...
            <p className="text-center text-sm text-muted-foreground">{t("noAccount")}{" "}<a href={`/${params.locale}/register`} className="text-primary hover:underline font-medium">{t("createAccount")}</a></p>
          </div>
        </motion.div>
      </main>
